...
public class ExceptionHandlingControllerTest {
	...
	public void setUp() throws Exception {
		this.apiEndPoint = "http://localhost:" + port + "/local/";
		template = new TestRestTemplate();
	}


	@Test
	public void 例外を通知する_デフォルト() throws Exception {
		// 操作
	...
	@Test
	public void 例外を通知する_OrderNotFoundExceptionの場合() throws Exception {
		// 操作
		ResponseEntity<String> response = 
	...
	@Test
	public void 例外を通知する_引数が重複した場合() throws Exception {
		// 操作
		ResponseEntity<String> response = 
		...
		Map<String, String> propertyMap = getBodyProperties(response);
		// ボディ
		assertThat(propertyMap.get("message"), is("IDが重複しています"));
		// ステータスコード
		assertThat(response.getStatusCode(), is(HttpStatus.CONFLICT));
	}

	@Test
	public void 例外を通知する_DBアクセスに失敗した場合() throws Exception {
		// 操作
		ResponseEntity<String> response = 
